...
function exercise1(num1) {
    ...
    // ------------------------------------------
        ...
        if(num1 > 10){
            answer1 = `The value of num1 is ${num1} and is great than 10`;
        }
    // ------------------------------------------
    // And above here
    // ------------------------------------------
  ...
  function exercise4(varA, varB) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if(varA && varB === 'string' || 'number' && varA === varB){
  ...
  //console.log(exercise4(500, "dino"));
  ...
  //One case would be null and 0, since null represents an absensce of a value
  //it would be expected to equal to 0, but it does not. 
  ...
  //console.log(exercise8(1,401,50,400));
  ...
  // These exercises were easy, while writing if statements I had to remind myself order matters and think about 
  //what I'm comparing before writing the code. s
